...
function diaDeLaSemana(numeroDeDia) {
  ...
  for (let i = 0; i < dias.length; i++) {
    if (
      dias[numeroDeDia - 1] === "Domingo" ||
      dias[numeroDeDia - 1] === "Sabado"
    ) {
...
function mesesDelAño(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    if (
      ...
      mesesPerdidos[j] = array[i];
      j++;
    }
  }
  if (
    mesesPerdidos.includes("Enero") &&
    mesesPerdidos.includes("Marzo") &&
    mesesPerdidos.includes("Noviembre")
  )
